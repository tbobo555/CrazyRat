#ifndef GameSprite_PlayButton_H_
#define GameSprite_PlayButton_H_
...
{
    class PlayButton : public BaseSprite
    {
    public:
        /**
         @brief 建構式
...
#endif /* GameSprite_PlayButton_H_ */
